...
\lstdefinelanguage{Bleach}{
    % Define keywords
    morekeywords={and, break, class, continue, do, elif, else, false, for, function, if, inherits, lambda, let, method, nil, or, print, return, self, super, true, whole},
...
\input{development_I.tex}
\input{development_II.tex}
\input{resultsFixed}
