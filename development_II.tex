...
\begin{itemize}
    \item \texttt{std::chrono}
        \begin{itemize}
            \item \texttt{std::chrono::clock}:
        \end{itemize}
    \item \texttt{std::io}
        \begin{itemize}
            \item \texttt{std::io::fileRead}:
            
            \item \texttt{std::io::fileWrite}:
    ...
    \item \texttt{std::utils}
        \begin{itemize}
            ...
            \item \texttt{std::utils::strToNum}:

            \item \texttt{std::utils::strToBool}:


            \item \texttt{std::utils::strToNil}:
        \end{itemize}
\end{itemize}
