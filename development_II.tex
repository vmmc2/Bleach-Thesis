...
\begin{itemize}
    \item \textbf{Classes:} A class is basically a "blueprint" for creating instances/object. Bleach takes the same approach as Python when it comes to classes: when the user a class defines a set of attributes (variables) and methods (functions) that the created objects will have as its disposal.
