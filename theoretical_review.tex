...
\begin{figure}[H]  
  ...
  \textwidth]{Figures/Arquiteturas/CompilersDetailedPipeline.png}  
...
\begin{figure}[H]  
  \centering
  \includegraphics[width=1.0
  \textwidth]{Figures/Arquiteturas/CompilersSimplifiedPipeline.png}  
...
\subsection{Lexer}
The lexer is the first component present in the compiling process of a compiler. It is responsible for executing a process called lexing, also know as lexical analysis. 
